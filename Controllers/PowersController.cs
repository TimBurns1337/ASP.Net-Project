...
namespace ASP.Net_project.Controllers
{
    public class PowersController : Controller
    {
        ...
        public PowersController(ComputerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PowerId,PowerName,PowerPrice,ImageLink")] Power power)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PowerId,PowerName,PowerPrice,ImageLink")] Power power)
        {
            if (id != power.PowerId)
            {
                return NotFound();
